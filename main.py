    ...
    def shortestPath(self):
        ...
        while F is not None:
            ...
            for pathFromStart in configurations:
                last_node_in_path_from_start = pathFromStart[-1]
                ...
                if visited[last_node_in_path_from_start] != [] and visited[last_node_in_path_from_start][1] < c :
                    ...
                    check = "dead end"
                elif last_node_in_path_from_start is self.end_node and len(pathFromStart) >= self.min_items:
                    check = "solution found"
                else:
                    check = "continue"
                    # update the node
                    # visited[last_node_in_path_from_start] = [pathFromStart,c]
                # print(pathFromStart)

                if check == "solution found":
                    # print("check", check)
                    if c < b[2]:
                        b = [last_node_in_path_from_start, pathFromStart, c]
                    # F = None
                    ...
                    if self.lowerBound(last_node_in_path_from_start, pathFromStart) < b[2] :
                        cost = self.lowerBound(last_node_in_path_from_start, pathFromStart)
                        # if last_node_in_path_from_start not in F.keys():
                        F[last_node_in_path_from_start]= [pathFromStart, cost]
